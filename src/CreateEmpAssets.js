                    ...
                    <form className='container py-3  mb-3' onSubmit={(e) => { submit(e) }}>
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.assetUser || ''}
                                    type="text"
                                    id="assetUser"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.assetName || ''}
                                    type="text"
                                    id="assetName"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.assetId || ''}
                                    type="text"
                                    id="assetId"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.assetNo || ''}
                                    type="text"
                                    id="assetNo"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.assetType || ''}
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.processor || ''}
                                    type="text" className="form-control"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.ram || ''}
                                    type="text" className="form-control"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.diskType || ''}
                                    type="text" className="form-control"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.operatingSystem || ''}
                                    type="text" className="form-control"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.purchesDate || ''}
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.warrenty || ''}
                                    type="text" className="form-control"
                        ...
                        <div className="row mb-3">
                            ...
                            <div className="col-sm-10">
                                <input onChange={(e) => { handle(e) }} value={data.warrentyDate || ''}
                                    type="date" className="form-control"
                                    id="warrentyDate" />
                            </div>
                        </div>
